    ...
    while True:
        ...
        if ball_down == False:
            if now_ball_position[1] == 80:
                if len(params) == 4:
                    params.append(int(scene_info.ball[0]))
                    ws.append(params)
        else:
            if now_ball_position[1] == 415:
                params = [int(scene_info.ball[0]), int(scene_info.ball_speed), round(m, 2), int(scene_info.frame % 200)]
        ...
        if now_ball_position[1] == 415:
            ...
            cc = aid % 5
            aid -= cc
            print(scene_info.platform_2P[0], aid)
